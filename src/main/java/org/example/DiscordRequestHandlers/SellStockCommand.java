...
public class SellStockCommand extends ResponseCommandAdapter{

    public SellStockCommand(String commandId) {
        super(commandId);
    }
    ...
    public CommandResponse execute() {
        ...
        int ans = TradeHandler.getInstance().sellStock(user, new Stock(symbol, amount));
        if (ans == -2){
